...
def initialize_buffers():
    ...
    data_buffer[1] = ListBuffer([], maxlen=buffer_length)  # time data
...
def update_data():
    ...
    data_buffer[3].add(data[3])  #ir filtered data (re-filters data // don't use, not accurate)
    ...
    if (timer_1.time_up()):
            t_hr, hr = hr_calc1.process(data_buffer[0], data_buffer[1])
